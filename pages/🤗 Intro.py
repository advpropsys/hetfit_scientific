...
def img_to_html(img_path, img_alt):
    ...
    img_html = f'<img src="data:image/{img_format.lower()};base64,{img_to_bytes(img_path)}" alt="{img_alt}" style="max-width: 60%; margin-left: auto; margin-right: auto;">'
...
with open("intro.md", "r+") as readme_file:
